...
util.inherits(WorkflowBackend, events.EventEmitter);
...
WorkflowBackend.prototype.createWorkflow = function (workflow, meta, callback) {
...
//        job properties
// callback - f(err, job)
WorkflowBackend.prototype.createJob = function (job, meta, callback) {
...
//        workflow properties
// callback - f(err, workflow)
WorkflowBackend.prototype.getWorkflow = function (workflow, meta, callback) {
...
//        job properties
// callback - f(err, job)
WorkflowBackend.prototype.getJob = function (job, meta, callback) {
...
//        workflow properties
// callback - f(err, workflow)
WorkflowBackend.prototype.updateWorkflow = function (workflow, meta, callback) {
...
//        workflow properties
// callback - f(err, job)
WorkflowBackend.prototype.updateJob = function (job, meta, callback) {
...
WorkflowBackend.prototype.deleteWorkflow = function (workflow, meta, callback) {
...
// Get all the jobs/search jobs by execution or params:
...
//        job info properties
// - callback - f(err)
WorkflowBackend.prototype.addInfo = function (uuid, info, meta, callback) {
...
//        job info properties
// - callback - f(err, info)
WorkflowBackend.prototype.getInfo = function (uuid, meta, callback) {

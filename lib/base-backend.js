...
var baseBackend = {
    ...
    createWorkflow: function (pWorkflow, pMeta, pCallback) {
        ...
        var _self = this;
        this.find(this.TYPES.WORKFLOWS, {'name': pWorkflow.name}, function (pError, pWorkflows) {
            ...
            _self.save(_self.TYPES.WORKFLOWS, pWorkflow, pCallback);
        });
    },
    // usage: API & Factory
    // uuid - Workflow.uuid
    ...
    getWorkflow: function (uuid, meta, pCallback) {
        ...
        this.find(this.TYPES.WORKFLOWS, uuid, function (pError, pWorkflows) {
            if (pWorkflows.length === 0)
    ...
    deleteWorkflow: function (workflow, meta, pCallback) {
        ...
        this.remove(this.TYPES.WORKFLOWS, workflow, pCallback);
    },
    // usage: API
    ...
    updateWorkflow: function (workflow, meta, pCallback) {
        ...
        this.getWorkflow(workflow.uuid, meta, function (pError, pWorkflow) {
            ...
            _self.find(_self.TYPES.WORKFLOWS, {'name': pWorkflow.name}, function (pError, pWorkflows) {
                if (pWorkflows.length > 0)
    ...
    createJob: function (job, meta, pCallback) {
        ...
        this.save(this.TYPES.JOBS, job, pCallback);
    },
    ...
    getJob: function (uuid, meta, pCallback) {
        ...
        this.find(this.TYPES.JOBS, uuid, function (pError, pJobs) {
            if (pJobs.length === 0)
                return pCallback(new e.BackendResourceNotFoundError(sprintf(
    ...
    validateJobTarget: function (pJob, pCallback) {
        ...
        var _self = this;
        _self.find(_self.TYPES.JOBS, null, function (pError, pJobs) {
            if (pError || !pJobs)
                return pCallback(null);
    ...
    runJob: function (uuid, runner_id, pCallback) {
        ...
        this.find(this.TYPES.JOBS, uuid, function (pError, pJobs) {
            ...
            return _self.save(_self.TYPES.JOBS, job, pCallback);
        });
    },
    ...
    finishJob: function (pJob, pCallback) {
        var _self = this;
        this.find(this.TYPES.JOBS, pJob.uuid, function (pError, pJobs) {
            if (pJobs.length === 0)
                return pCallback(new e.BackendResourceNotFoundError(sprintf(
            ...
            _self.save(_self.TYPES.JOBS, job, pCallback);
        });
    },
    ...
    getRunner: function (runner_id, pCallback) {
        this.find(this.TYPES.RUNNERS, runner_id, function (pError, pRunners) {
    ...
    getRunners: function (pCallback) {
        this.find(this.TYPES.RUNNERS, null, function (pError, pRunners) {
            var theRunners = {};
    ...
    idleRunner: function (runner_id, pCallback) {
        ...
        this.find(this.TYPES.RUNNERS, runner_id, function (pError, pRunners) {
            ...
            runner.idle = true;
            _self.save(_self.TYPES.RUNNERS, runner, function (pError, pRunner) {
    ...
    isRunnerIdle: function (runner_id, pCallback) {
        this.find(this.TYPES.RUNNERS, runner_id, function (pError, pRunners) {
            return pCallback((pRunners.length === 1 && pRunners[0].idle === true));
        });
    },
    ...
    getRunnerJobs: function (runner_id, pCallback) {
        this.find(this.TYPES.JOBS, {'runner_id': runner_id}, function (pError, pJobs) {
    ...
    getWorkflows: function (params, pCallback) {
        ...
        this.find(this.TYPES.WORKFLOWS, params, pCallback);
    },
    ...
    getJobs: function (params, pCallback) {
        ...
        this.find(this.TYPES.JOBS, whereObj, function (pError, pJobs) {
            if (pError)
    ...
    countJobs: function (pCallback) {
        ...
        this.find(this.TYPES.JOBS, null, function (pError, pJobs) {
